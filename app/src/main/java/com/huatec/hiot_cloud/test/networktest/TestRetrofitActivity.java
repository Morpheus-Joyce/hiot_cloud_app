...
public class TestRetrofitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdateEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                updateEmail("47d597d6ad0f41448bc05848e2bd9f0c_65248ec1cfb649369e49e35754c4624e_use",
                        "zwr2@qq.com");
            }
        });
    ...
    private void register() {
        ...
        userBean.setUsername("zwr1");
        userBean.setEmail("zwr1@qq.com");
    ...
    private void callEqueue(Call<ResponseBody> call) {
    ...
    private void callEqueueLogin(Call<ResponseBody> call) {
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
//                    Log.d(TAG, "onResponse" + response.body().string());
    ...
    private void callEqueueUserInfo(Call<ResponseBody> call) {
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
